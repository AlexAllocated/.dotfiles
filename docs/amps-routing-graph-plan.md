# AMPS: unified routing canvas design and rollout
...
[current AMPS guide](../packages/amps/README.md) for actual behavior.
...
only AMPS-owned routes, devices, and processing; no arbitrary DSP insertion or Linux
...
and routes created outside AMPS remain beyond what this graph can prove.
...
provides keyboard/screen-reader scaffolding; it does not supply AMPS's
